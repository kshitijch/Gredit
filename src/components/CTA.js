...
const CTA = () => {
    return (
        <div className='bg-gradient-to-b from-white to-blue-100 flex sm:flex-row flex-col  py-6 sm:py-20 px-2' >
            <div
                className=" border-4 border-blue-600  p-10 w-full max-w-4xl rounded-xl font-[sans-serif] overflow-hidden mx-auto mt-4">
            ...
            <div
                className=" border-4 border-blue-600 p-10 w-full max-w-lg rounded-xl font-[sans-serif] overflow-hidden mx-auto mt-4">
                <div className="inline-block bg-[#edf2f7] rounded-lg py-2 px-3">
